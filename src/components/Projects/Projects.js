  ...
  return (
    <motion.div animate={{ opacity: 1 }} initial={{ opacity: 0 }} transition={{ duration: .4 }}>
      <section className="projects-container">
        ...
        <p className="dyno-message">It might take a few seconds to wake up the Heroku servers on the deployed links.</p>
        <p className="dyno-message">Got to love those free dynos right?</p>
